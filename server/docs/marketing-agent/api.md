...
## Route Surface Guidance

- product routes live under `/api/*`
- internal operational routes live under `/api/internal/*`
- no compatibility namespace is required for the current architecture
