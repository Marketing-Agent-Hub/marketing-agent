                ...
                <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            {...register('name')}
                            type="text"
                            className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2 border bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                        />
                        {errors.name && (
                    ...
                    <div>
                        ...
                        <div className="mt-1 flex gap-2">
                            <input
                                {...register('rssUrl')}
                                type="url"
                                className="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2 border bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                            />
                            <button
                                type="button"
                        ...
                        {errors.rssUrl && (
                            <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.rssUrl.message}</p>
                        )}
                        {validationResult && (
                            <div
                    ...
                    <div>
                        ...
                        />
                        {errors.siteUrl && (
                            <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.siteUrl.message}</p>
                        )}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            />
                            {errors.trustScore && (
                                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.trustScore.message}</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 dark:bg-indigo-500 border border-transparent rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-400 disabled:opacity-50"
                        >
