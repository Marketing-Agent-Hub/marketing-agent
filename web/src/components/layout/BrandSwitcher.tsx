                        ...
                        <div className="max-h-48 overflow-y-auto pb-1">
                            {brands?.map((brand) => (
                                <button
                                    ...
                                    style={{
                                        background: brand.id === bid ? 'var(--sidebar-item-active)' : undefined,
                                        color: brand.id === bid ? 'var(--sidebar-item-active-text)' : 'var(--color-text)',
                                    }}
                                    onMouseEnter={(e) => { if (brand.id !== bid) (e.currentTarget as HTMLElement).style.background = 'var(--sidebar-item-hover)'; }}
                                    onMouseLeave={(e) => { if (brand.id !== bid) (e.currentTarget as HTMLElement).style.background = ''; }}
                                >
